...
| Recall | **忆往** | 拿到第四幕钥匙之一 | 见 [09 多幕](09-acts-and-progression-done.md) |
...
- 弱依赖 [01 遗物](01-relics-done.md)（掘藏/弃甲/举鼎的解锁条件）
- **产出被复用**：`RoomScene` 壳是 [05 商店](05-shop-done.md) 和
  [06 事件](06-events-done.md) 的基础
