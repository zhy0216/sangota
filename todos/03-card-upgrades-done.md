...
[05 商店](05-shop-done.md)（移除卡）、[07 牌堆查看器](07-deck-viewer-done.md)、
[14 诅咒](14-curses-and-status-cards-done.md) 都需要同样的实例化牌组。
...
6. 升级入口先只接 [04 营帐](04-campfire-done.md) 的铁匠。选卡界面复用
...
无。但它引入的 `DeckCard` 是 [05 商店](05-shop-done.md)、[07 牌堆查看器](07-deck-viewer-done.md)、
[14 诅咒与状态牌](14-curses-and-status-cards-done.md)、[22 结算界面](22-run-summary.md)
的共同前提，**应当尽早做**，越晚重构面越大。
